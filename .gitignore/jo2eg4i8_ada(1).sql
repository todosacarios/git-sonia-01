...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-12-2022 a las 19:18:27
...
--
-- Estructura de tabla para la tabla `tblap_forms`
--

CREATE TABLE `tblap_forms` (
  `idForm` int(11) NOT NULL,
  `formDate` timestamp NOT NULL DEFAULT current_timestamp(),
  `formTitle` text NOT NULL,
  `formStart` date NOT NULL,
  `formEnd` date NOT NULL,
  `formEmpCode` int(11) NOT NULL,
  `formEmpName` text NOT NULL,
  `formGrade` text NOT NULL,
  `formSalary` double NOT NULL,
  `formCHrs` double NOT NULL,
  `formContractDate` date NOT NULL,
  `formHourlyRate` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `tblap_forms`
--

INSERT INTO `tblap_forms` (`idForm`, `formDate`, `formTitle`, `formStart`, `formEnd`, `formEmpCode`, `formEmpName`, `formGrade`, `formSalary`, `formCHrs`, `formContractDate`, `formHourlyRate`) VALUES
(13, '2022-12-26 23:00:00', 'Dec 22', '2022-01-10', '2022-09-25', 1, 'Juan Mendoza', '', 0, 39, '2022-01-01', 0),
(14, '2022-12-26 23:00:00', 'Dec 22', '2022-01-10', '2022-09-25', 2, 'Pedro Gonzalez', '', 0, 15.5, '2021-12-01', 0),
(15, '2022-12-26 23:00:00', 'Dec 22', '2022-01-10', '2022-09-25', 3, 'Raul Rodriguez', '', 0, 20, '2022-05-05', 0),
(16, '2022-12-26 23:00:00', 'Dec 22', '2022-01-10', '2022-09-25', 4, 'Daniel Martinez', '', 0, 39, '2022-03-05', 0);
...
--
-- Indices de la tabla `tblap_forms`
--
ALTER TABLE `tblap_forms`
...
--
-- AUTO_INCREMENT de la tabla `tblap_forms`
--
ALTER TABLE `tblap_forms`
  MODIFY `idForm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
